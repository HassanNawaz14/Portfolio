...
const cardStyle = (i, active) => {
  if (active === null) return {};
  if (i === active) return { transform: 'scale(1.5) translateY(-5px)', zIndex: 99999, position: 'relative' };
  if (i === active - 1 || i === active + 1) return { transform: 'scale(1.3) translateY(-3px)', zIndex: 9999, position: 'relative' };
  if (i === active - 2 || i === active + 2) return { transform: 'scale(1.15)', zIndex: 999, position: 'relative' };
  return {};
};
  ...
  return (
    <section id="certifications" className="certifications-section">
      <div className="container">
        ...
        <div className="certifications-comic-panel" ref={panelRef}>
          <div className="certifications-cards-row mcerts-row">
            {certifications.map((cert, i) => (
              <div
                key={cert.id}
                className="certifications-card mcerts-card"
                style={cardStyle(i, activeCard)}
