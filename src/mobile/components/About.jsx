  ...
  return (
    <section id="about" className="about-section">
      <div className="container">
        ...
        <div className="about-glass-panel mabout-panel">
          <div className="mabout-tabs">
            {tabs.map((tab) => (
              <button
                key={tab.id}
                className={`mabout-tab ${activeTab === tab.id ? 'active' : ''}`}
                onClick={() => setActiveTab(tab.id)}
              >
                <i className={`fa-solid ${tab.icon}`} />
                <span>{tab.label}</span>
                {activeTab === tab.id && (
                  <motion.div layoutId="aboutTabActive" className="mabout-tab-bar" />
                )}
              </button>
            ))}
          </div>
