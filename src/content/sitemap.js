...
export const sitemap = [
  {
    ...
    sections: [
      ...
      { id: 'experience', anchor: '#experience', title: 'Experience', description: 'Professional work experience and industry collaborations', keywords: ['experience', 'work', 'internship', 'industry', 'professional'] },
      { id: 'education', anchor: '#education', title: 'Education', description: 'Academic journey and educational milestones', keywords: ['education', 'fast nuces', 'data science', 'academic'] },
      { id: 'courses', anchor: '#courses', title: 'Course Log', description: 'Extracurricular courses and self-study', keywords: ['courses', 'extracurricular', 'learning', 'self-study'] },
